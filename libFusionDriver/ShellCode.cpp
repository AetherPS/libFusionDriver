...
namespace Fusion
{
	...
	int LoadSprx(int processId, const char* path)
	{
		...
		int res = Resolve(processId, libkernelHandle, "libkernel", "sceKernelLoadStartModule", 0, &shellCodeHeader->sceKernelLoadStartModule);
		if (res != 0)
		{
	...
	int UnloadSprx(int processId, int handle)
	{
		...
		int res = Resolve(processId, libkernelHandle, "libkernel", "sceKernelStopUnloadModule", 0, &shellCodeHeader->sceKernelStopUnloadModule);
		if (res != 0)
		{
